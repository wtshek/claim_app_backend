...
// Initalize kernel
require_once( dirname(dirname(dirname(dirname(__FILE__)))) . '/kernel.php' );
$kernel = new kernel( 'admin_site', 'en/admin/' );

// Toggle between AWS and local file system
$function_prefix = $kernel->conf['aws_enabled'] ? 's3_' : '';
$copy = $function_prefix . 'copy';
$deleteDir = $function_prefix . 'deleteDir';
$file_exists = $function_prefix . 'file_exists';
$file_get_contents = $function_prefix . 'file_get_contents';
$file_put_contents = $function_prefix . 'file_put_contents';
$filemtime = $function_prefix . 'filemtime';
$filesize = $function_prefix . 'filesize';
$getimagesize = $function_prefix . 'getimagesize';
$is_dir = $function_prefix . 'is_dir';
$mkdir = $function_prefix . 'mkdir';
$rename = $function_prefix . 'rename';
$scandir = $function_prefix . 'scandir';
$unlink = $function_prefix . 'unlink';
...
$config = array(
	...
	*/
	...
	|
	*/
	'current_path' => $kernel->conf['aws_enabled'] ? '' : '../../file/',
	...
	*/
	...
	'chmod_files'                             => false, // change file permissions (AVALADE: please do not enable as it is not supported)
	'chmod_dirs'                              => false, // change folder permissions (AVALADE: please do not enable as it is not supported)
	'preview_text_files'                      => true, // eg.: txt, log etc.
	'edit_text_files'                         => true, // eg.: txt, log etc.
	'create_text_files'                       => true, // only create files with exts. defined in $editable_text_file_exts

	// you can preview these type of files if $preview_text_files is true
	'previewable_text_file_exts'              => array( 'css', 'htm', 'html', 'js', 'log', 'txt', 'xhtml', 'xml' ),
	'previewable_text_file_exts_no_prettify'  => array( 'log', 'txt' ),

	// you can edit these type of files if $edit_text_files is true (only text based files)
	// you can create these type of files if $create_text_files is true (only text based files)
	// if you want you can add html,css etc.
	// but for security reasons it's NOT RECOMMENDED!
	'editable_text_file_exts'                 => array( 'css', 'htm', 'html', 'js', 'log', 'txt', 'xhtml', 'xml' ),

	// Preview with Google Documents
	'googledoc_enabled'                       => true,
	'googledoc_file_exts'                     => array( 'doc', 'docx', 'ppt', 'pptx', 'xls', 'xlsx' ),

	// Preview with Viewer.js
	'viewerjs_enabled'                        => true,
	'viewerjs_file_exts'                      => array( 'odp', 'ods', 'odt', 'pdf' ),
	...
	//**********************
	'ext_img'                                 => array( 'bmp', 'gif', 'jpeg', 'jpg', 'png', 'svg', 'tiff' ), //Images
	'ext_file'                                => array( 'accdb', 'ade', 'adp', 'ai', 'css', 'csv', 'doc', 'docx', 'fla', 'htm', 'html', 'log', 'mdb', 'odb', 'odf', 'odg', 'odp', 'ods', 'odt', 'otg', 'otp', 'ots', 'ott', 'pdf', 'ppt', 'pptx', 'psd', 'rtf', 'sql', 'txt', 'xhtml', 'xls', 'xlsx', 'xml' ), //Files
	'ext_video'                               => array( 'avi', 'flv', 'm4v', 'mov', 'mp4', 'mpeg', 'mpg', 'webm', 'wma' ), //Video
	'ext_music'                               => array( 'ac3', 'aiff', 'm4a', 'mid', 'mp3', 'ogg', 'wav' ), //Audio
	'ext_misc'                                => array( 'bin', 'dmg', 'csf', 'fw', 'gz', 'iso', 'jar', 'jr', 'rar', 'tar', 'vcf', 'zip' ), //Archives
	 ...
	 * JAVA upload
	 *******************/
	'java_upload'                             => false, // AVALADE: please do not enable as it is not supported
	...
	// AVALADE: please do not enable as it is not supported
